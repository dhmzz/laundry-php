                        ...
                        <div class="card-body">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th style="width : 5%">
                                        <a type="button" class="btn btn-primary" href="./createData/add_paket.php">Add Paket</a>
                                    </th>
                                </tr>
                                </thead>
                                <tbody>
                                        ...
                                        <?php
                                            ...
                                            while($data_paket=mysqli_fetch_array($qry_paket)){?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    <a href="./editData/ubah_paket.php?id_paket=<?php echo $data_paket['id_paket']?>" class="btn btn-success">Ubah</a>
                                                    <a href="./deleteData/hapus_paket.php?id_paket=<?php echo $data_paket['id_paket']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger">Hapus</a>
                                                    </td>             
                                                </tr>
                                                </div>
                                                </div>
